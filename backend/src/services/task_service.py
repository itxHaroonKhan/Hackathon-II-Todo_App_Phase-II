...
class TaskService:
    ...
    def create_task(
        ...
        LogService.create_log_entry(
            ...
            user_id,
            action="create_task",
            details=f"Created task with ID: {task.id}"
        )
        return task
    ...
    def update_task(
        ...
        LogService.create_log_entry(
            ...
            user_id,
            action="update_task",
            details=f"Updated task with ID: {task.id}"
        )
        return task
    ...
    def delete_task(
        ...
        LogService.create_log_entry(
            ...
            user_id,
            action="delete_task",
            details=f"Deleted task with ID: {task_id}"
        )
        return True
    ...
    def toggle_task_completion(
        ...
        LogService.create_log_entry(
            ...
            details=f"Toggled completion for task with ID: {task.id}. New status: {task.completed}"
        )
        return task
