...
# Project Instructions (Phase II – Full Stack)
...
- Authentication: Signup, Password Hashing, JWT Tokens
...
- Do NOT change existing functionality while optimizing.
...
## Active Skills (Use When Relevant)

### 1. Frontend UI Skill
- Build responsive, clean, modern UI.
...
- Keep endpoints secure and predictable.

### 3. Database Skill
- Use SQLModel for schema and queries.
- Maintain correct relationships (User → Tasks).
...
- Keep frontend and backend efficient.

---

## What This Project Is

- A real full-stack app, not a demo.
- Clean architecture matters.
- Security is mandatory, not optional.
- Code should be understandable by another developer.
- Everything must align with Phase II goals.

---

## What to Do When Asked

- If UI-related → apply Frontend UI Skill.
- If API-related → apply Backend API Skill.